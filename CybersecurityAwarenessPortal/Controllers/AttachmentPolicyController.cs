...
namespace CybersecurityAwarenessPortal.Controllers
{
    ...
    /// </summary>
    public class AttachmentPolicyController : Controller
    {
        /// <summary>
        /// This View is called when the attachment policy page is loaded
        /// </summary>
        /// <returns></returns>
        public ActionResult AttachmentPolicyView()
        {
            return View();
        }
    }
